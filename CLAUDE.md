...
origin_region values: West Africa | East Africa | Southern Africa | North Africa | Central Africa | African American | Afro-Caribbean | Afro-Brazilian | Afro-European | Afro-Latinx
  Afro-European -- African descent in a European context. Unlike African American / Afro-Caribbean / Afro-Brazilian (where the transatlantic slave trade severed the continental origin, so the community IS the origin), Black European identity is usually one or two generations deep and the origin is often known. Use Afro-European ALONGSIDE a continental value where the specific origin is documented (e.g. ["West Africa", "Afro-European"] for a French-born artist of Malian descent). Use it ALONE only where the continental origin cannot be sourced.
